...
CLASSES = {
    "2A_GD": {
        ...
        "Robotiques médicales": {"volume": 24, "tp_seances": 3},
        ...
        "Bases de données Avancées": {"volume": 56, "tp_seances": 3},
    ...
    "1A_EE": {
        "Microbiologie de l'environnement": {"volume": 28, "tp_seances": 4},
        "Géophysique environnementale": {"volume": 28, "tp_seances": 0},
        "Chagement climatiques": {"volume": 28, "tp_seances": 0},
        "Chimie de l'environnement": {"volume": 28, "tp_seances": 8},
        "Analyses électrochimiques et spectrales": {"volume": 28, "tp_seances": 0},
        "Résistance des Matériaux": {"volume": 28, "tp_seances": 4},
        "Topographie": {"volume": 28, "tp_seances": 0},
        "SIG et télédiction": {"volume": 28, "tp_seances": 8},
        "Bases de données": {"volume": 24, "tp_seances": 0},
        "Statistique et probabilité": {"volume": 24, "tp_seances": 0},
        "Programmation Orienté Objet": {"volume": 28, "tp_seances": 0},
        "Recherche opérationnelle": {"volume": 28, "tp_seances": 0},
        "TOEIC": {"volume": 24, "tp_seances": 0},
        "Compétences culturelles et Artistiques": {"volume": 24, "tp_seances": 0},
        "ESP": {"volume": 48, "tp_seances": 0},
        "Français": {"volume": 24, "tp_seances": 0},
...
PROFESSEURS = {
    "Pr.JBAHI": {"modules": ["SIG et télédiction", "Radioactivité", "Analyses électrochimiques et spectrales", "Topographie"], "type": "vacataire", "disponibilites": ["Mardi", "Jeudi"]},
    "Pr.FAIZ": {"modules": ["Anglais"], "max_heures": 40, "type": "permanent"},
    "Pr.MOUMADI": {"modules": ["Programmation Orienté Objet"], "max_heures": 40, "type": "permanent"},
    "Pr.ASRAOUI": {"modules": ["Statistique et probabilité"], "max_heures": 40, "type": "permanent"},
    "Pr.ERRABIH": {"modules": ["Droit"], "max_heures": 40, "type": "permanent"},
    "Pr.KHALFAOUI": {"modules": ["Recherche opérationnelle"], "max_heures": 40, "type": "permanent"},
    "Pr.AMEZIANE": {"modules": ["CAO-DAO"], "max_heures": 40, "type": "permanent"},
    "Pr.MERZOUQI": {"modules": ["Bases de données", "Bases de données Avancées", "Réalisation", "Gestion de projet", "Bases de Traitement d'images médicales", "Mini projet de Traitement d'image"], "max_heures": 40, "type": "permanent"},
    "Pr.BETTASS": {"modules": ["Résistance des Matériaux", "Robotiques médicales", "Biostatistiques"], "max_heures": 40, "type": "permanent"},
    "Pr.KAHKAHY": {"modules": ["Français"], "max_heures": 40, "type": "permanent"},
    "Pr.BOUHALI": {"modules": ["Français"], "max_heures": 40, "type": "permanent"},
    "Pr.ANSARI": {"modules": ["Chagement climatiques", "Chimie de l'environnement", "Géophysique environnementale", "Microbiologie de l'environnement", "Anatomie", "Gestion de l'entreprise et Marché public"], "max_heures": 40, "type": "permanent"},
    ...
    "Pr.BANOUARAB": {"modules": ["ESP"], "max_heures": 40, "type": "permanent"},
    ...
    "Pr.MEFADDEL": {"modules": ["TOEIC"], "type": "vacataire", "disponibilites": ["Jeudi", "Mercredi"]},
    ...
    "Pr.JOUICHA": {"modules": ["TP SIG et télédiction"], "type": "doctorant"},
    "Pr.ACHLIOUI": {"modules": ["TP Résistance des Matériaux"], "type": "doctorant"},
    "Pr.SAQAT": {"modules": ["TP Microbiologie de l'environnement", "TP Chimie de l'environnement"], "type": "doctorant"}
}
