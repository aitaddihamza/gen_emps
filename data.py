...
PROFESSEURS = {
    "Pr.JBAHI": {"modules": ["Radioactivité"], "max_heures": 40, "type": "permanent"},
    ...
    "Pr.ANSARI": {"modules": ["Anatomie", "Gestion de l'entreprise et Marché public"], "max_heures": 40, "type": "permanent"},
    ...
    "Pr.ACHIR": {"modules": ["TP Bases de Traitement d'images médicales", "TP Imagerie Médicale", "TP Physiologie"], "type": "doctorant"},
