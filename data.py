...
CLASSES = {
    "2A_GD": {
        ...
        "Robotiques médicales": {"volume": 56, "tp_seances": 2},
    ...
    "2A_GB": {
        "Imagerie Médicale": {"volume": 30, "tp_seances": 0},
        "Biostatistiques": {"volume": 30, "tp_seances": 0},
        "Bioinformatique": {"volume": 30, "tp_seances": 0},
        "Physiologie": {"volume": 30, "tp_seances": 0},
...
PROFESSEURS = {
    ...
    "Pr.BEHJA": {"modules": ["Economie de santé"], "max_heures": 40, "type": "permanent"},
    "Pr.SAWALMEH": {"modules": ["Anglais"],"type": "vacataire", "disponibilites": ["Mercredi"]},
    "Pr.KHAY": {"modules": ["Organisation hospitalière"], "type": "vacataire", "disponibilites": ["Mercredi"]},
    "Pr.HOUSBANE": {"modules": ["Bioinformatique"], "type": "vacataire", "disponibilites": ["Jeudi"]},
    "Pr.EL YANDOUZI": {"modules": ["Machine learning"], "type": "vacataire", "disponibilites": ["Jeudi"]},
